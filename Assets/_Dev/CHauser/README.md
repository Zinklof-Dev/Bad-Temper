...
player settings class, this should be static, and include variables you'd expect for settings, from username, sensitivity, etc. etc. this will hook into a settings menu later, and other menus.. then will eventually hook into a persistance system to save these settings to disc.
